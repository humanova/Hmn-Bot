...
komut = {
    "yardim" : yardim["komutlar"] + yardim["yonetim"] + yardim["sikayet"] + yardim["rolver"] + yardim["genel"] + yardim["durt"] + yardim["oyla"] + yardim["google"] + yardim["lmgtfy"] + yardim["doviz"] + yardim["btc"] + yardim["server"] + yardim["roller"] +  yardim["gelistirici"]  +yardim["statu"] + yardim["surum"] + yardim["eglence"] + yardim["sence"] + yardim["self"] + yardim["bitis"] + yardim["karakter"],
